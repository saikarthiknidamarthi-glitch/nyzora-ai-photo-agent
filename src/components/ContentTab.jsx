    ...
    <div className="max-w-5xl mx-auto p-8">
      ...
      <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800 mb-6">
        ...
        <div className="space-y-5">
          <div>
            <h3 className="font-semibold text-indigo-400">Composition</h3>
          ...
          <div>
            <h3 className="font-semibold text-indigo-400">Lighting</h3>
            <p className="text-zinc-300">
          ...
          <div>
            <h3 className="font-semibold text-indigo-400">Framing</h3>
            <p className="text-zinc-300">
          ...
          <div>
            <h3 className="font-semibold text-indigo-400">Exposure</h3>
            <p className="text-zinc-300">
          ...
          <div>
            <h3 className="font-semibold text-indigo-400">Focus</h3>
            <p className="text-zinc-300">
      ...
      <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800 mb-6">
        ...
        <div className="space-y-6">
          <div>
            <h3 className="text-green-400 font-semibold mb-2">Minimal</h3>
          ...
          <div>
            <h3 className="text-blue-400 font-semibold mb-2">Storytelling</h3>
            <p className="whitespace-pre-wrap">
          ...
          <div>
            <h3 className="text-purple-400 font-semibold mb-2">Professional</h3>
            <p className="whitespace-pre-wrap">
